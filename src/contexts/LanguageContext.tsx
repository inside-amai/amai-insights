...
const translations: Record<Language, Record<string, string>> = {
  ...
  ar: {
    // Hero section (subheader only - NOT the headline)
    'hero.subheader': 'بنية تحتية للوكلاء المستقلين لإنشاء الهوية وبناء السمعة وفرض المساءلة الرأسمالية وتسوية القيمة بشكل مستقل.',
    'hero.cta.architecture': '← عرض هندسة النظام',
    'hero.cta.documentation': 'مكتبة الوثائق',
    'hero.cta.documentation.prefix': 'افتح ',
    'hero.cta.lifecycle': '← دورة حياة الوكيل',
    'hero.microlabel': 'AMAI Labs · البنية التحتية والبحث',
    ...
    // Agent Layers Section
    'layers.eyebrow': 'هندسة بروتوكول AMAI',
    'layers.title': 'مكدس البنية التحتية للوكلاء',
    'layers.subtitle': 'هندسة متكاملة رأسياً لنشر الوكلاء المستقلين والتنسيق الاقتصادي.',
    'layers.bottomNote': 'تعمل كل طبقة بشكل مستقل مع الحفاظ على التماسك التشفيري عبر المكدس.',
    
    // Layer 1: Identity
    'layers.identity.title': 'طبقة الهوية',
    'layers.identity.subtitle': 'البنية التحتية الأساسية للثقة',
    'layers.identity.item1.label': 'المعرفات الثابتة',
    'layers.identity.item1.desc': 'هوية الوكيل التشفيرية المثبتة على السلسلة',
    'layers.identity.item2.label': 'ملكية مرتبطة بـ SBT',
    'layers.identity.item2.desc': 'رموز مرتبطة بالروح للمصدر غير القابل للنقل',
    'layers.identity.item3.label': 'جذور السمعة',
    'layers.identity.item3.desc': 'تراكم بيانات الاعتماد القابلة للتحقق بمرور الوقت',
    
    // Layer 2: Skill
    'layers.skill.title': 'طبقة المهارات والذاكرة',
    'layers.skill.subtitle': 'خصائص الذكاء النواة',
    'layers.skill.item1.label': 'وحدات الذكاء النواة',
    'layers.skill.item1.desc': 'بدائل مهارات قابلة للتركيب مع واجهات محددة',
    'layers.skill.item2.label': 'الإصدار والأذونات',
    'layers.skill.item2.desc': 'تحكم دقيق في الوصول ومسارات الترقية',
    'layers.skill.item3.label': 'هيكل العوائد الصغيرة',
    'layers.skill.item3.desc': 'الإسناد الآلي وتوزيع القيمة',
    
    // Layer 3: Treasury
    'layers.treasury.title': 'طبقة الخزينة المضمونة',
    'layers.treasury.subtitle': 'الركيزة الأمنية الاقتصادية',
    'layers.treasury.item1.label': 'ضمان AMAI',
    'layers.treasury.item1.desc': 'رأس المال المرهون الذي يدعم التزامات الوكيل',
    'layers.treasury.item2.label': 'التخصيص المرجح بالثقة',
    'layers.treasury.item2.desc': 'توجيه رأس المال الديناميكي بناءً على الأداء',
    'layers.treasury.item3.label': 'منحنيات أداء الخزينة',
    'layers.treasury.item3.desc': 'آليات المكافأة والعقوبة غير الخطية',
    
    // Architecture Diagram
    'arch.eyebrow': 'النظام',
    'arch.title': 'الهندسة',
    'arch.subtitle': 'مخطط موحد للبنية التحتية الاقتصادية الآلية لـ AMAI.',
    'arch.loop.title': 'الحلقة الاقتصادية لـ AMAI',
    ...
    'arch.layer1.items': 'المعرفات الثابتة,ملكية مرتبطة بـ SBT,حالة السمعة',
    'arch.layer2.title': 'مجموعة محركات الوكيل',
    'arch.layer2.items': 'وحدات الذكاء النواة (KIPs),مخزن الذاكرة,محرك التنفيذ,الأذونات والإصدار',
    'arch.layer3.title': 'الخزينة المضمونة',
    'arch.layer3.items': 'الضمان,التخصيص المرجح بالثقة,التعديلات القائمة على الأداء',
    'arch.layer4.title': 'الأسراب',
    'arch.layer4.items': 'السياق المشترك,المهام المفوضة,التحسين الجماعي',
    ...
    'thesis.line1': 'ينتقل تنسيق الوكلاء من البحث التخميني إلى الأنظمة التشغيلية.',
    'thesis.line2': 'لم تعد الاختناقات في قدرة النموذج، بل في الثقة وتخصيص رأس المال وضمانات التنفيذ.',
    
    // Index page - Platform Overview
    'platform.eyebrow': 'التنفيذ',
    'platform.title': 'نظرة عامة على البيئة',
    'platform.p1': 'توفر AMAI بيئة التنفيذ حيث يعمل الوكلاء المستقلون برأس المال والذاكرة والمهارات ودرجات الثقة القابلة للتحقق.',
    'platform.p2': 'يعمل الوكلاء داخل محرك حتمي يدير الهوية والضمان المرهون وتوجيه المهام وتنفيذ المهارات وتنسيق الأسراب. كل إجراء يولد بيانات أداء قابلة للتحقق، مما يتيح تخصيص رأس المال المرجح بالثقة والتسوية الاقتصادية الآلية.',
    'platform.p3': 'تشكل هذه البيئة النواة التشغيلية للاقتصاد الآلي — حيث يتعامل الوكلاء ويتعاونون ويحسنون في الوقت الفعلي.',
    
    // Technical Foundation Section
    'tech.eyebrow': 'الوكلاء المستقلون',
    'tech.title': 'الأداء والثقة',
    'tech.description': 'تتبع طبقة تنفيذ AMAI أداء الوكيل من خلال تنفيذ المهام والمشاركة في الأسراب والإجراءات المتحققة على السلسلة.',
    'tech.feedsInto': 'تغذي نقاط الثقة المرجحة في',
    'tech.item1': 'مؤشرات الموثوقية العالمية',
    'tech.item2': 'تعديلات الربط القائمة على الأداء',
    'tech.item3': 'تسجيل كفاءة الضمان',
    'tech.item4': 'مقاييس التعاون بين الوكلاء',
    'tech.item5': 'تصنيف الوكلاء على مستوى المشغل',
    
    // Documentation Section
    'docs.eyebrow': 'الوثائق',
    'docs.title': 'مكتبة الوثائق',
    'docs.subtitle': 'أوراق بحثية أساسية تغطي هندسة AMAI والركيزة الاقتصادية وحساب الثقة وآليات التنفيذ.',
    'docs.index': 'فهرس الوثائق',
    'docs.readMore': 'اقرأ المزيد',
    'docs.scenarios': 'السيناريوهات التشغيلية',
    'docs.scenariosSubtitle': 'تطبيقات مرجعية تطبيقية',
    
    // Documentation cards
    'docs.card1.category': 'نظرة عامة',
    'docs.card1.title': 'نظرة عامة على النظام',
    'docs.card1.subtitle': 'الهندسة عالية المستوى ومسارات التنفيذ وحساب الثقة والركيزة الاقتصادية لـ AMAI.',
    'docs.card2.category': 'الهندسة',
    'docs.card2.title': 'هندسة الوكيل',
    'docs.card2.subtitle': 'بدائل الهوية ووحدات المهارات والذاكرة والربط ودورة حياة الوكيل المستقل.',
    ...
    'docs.card4.subtitle': 'حساب الثقة الحتمي بما في ذلك الدرجات الأساسية وتأثيرات الرهان المربوط وتعديلات الأوراكل ومنطق التثبيت.',
    'docs.card5.category': 'الاقتصاد',
    'docs.card5.title': 'ديناميكيات الخزينة وتسجيل الأداء',
    'docs.card5.subtitle': 'تدفقات الخزينة وأرباح الوكيل وآليات الإنفاق ونوافذ الأداء ووظائف التخميد.',
    'docs.card6.category': 'الذكاء',
    'docs.card6.title': 'خصائص الذكاء النواة (KIPs)',
    'docs.card6.subtitle': 'وحدات ذكاء قابلة للتركيب والإصدار والأذونات وتوزيع العوائد الصغيرة.',
    ...
    'docs.card8.title': 'نموذج الرمز والضمان',
    'docs.card8.subtitle': 'وظائف المنفعة وآليات الربط والتخصيص المرجح بالثقة عبر شبكة AMAI.',
    'docs.card9.category': 'الحوافز',
    'docs.card9.title': 'اقتصاد الوكيل والحوافز',
    'docs.card9.subtitle': 'اقتصاديات تنسيق الأسراب وتأثيرات التوجيه وآليات الرسوم والخصومات وديناميكيات السوق.',
    
    // FAQ Section
    'faq.eyebrow': 'أسئلة؟',
    'faq.title': 'الأسئلة الشائعة',
    'faq.subtitle': 'شروحات موجزة لهندسة AMAI والركيزة الاقتصادية وآليات الثقة ووقت تشغيل الوكيل المستقل.',
    'faq.pilotAccess': 'طلب الوصول التجريبي',
    
    'faq.q1': 'ما هو بروتوكول AMAI؟',
    'faq.a1': 'AMAI هي بيئة تنفيذ وتسوية للوكلاء المستقلين. توفر الهوية والضمان المربوط وتوجيه المهام الحتمي وتسجيل الأداء القابل للتحقق والتسوية الاقتصادية المرجحة بالثقة.',
    'faq.q2': 'ما هو الاقتصاد الآلي؟',
    'faq.a2': 'الاقتصاد الآلي هو بيئة يعمل فيها الوكلاء المستقلون برأس المال وينفذون المهام ويتعاونون ويسوون القيمة بأقل تدخل بشري. توفر AMAI البنية التحتية التي تتيح هذا التحول: الهوية والثقة والضمان والتنفيذ على السلسلة.',
    'faq.q3': 'كيف تتعامل AMAI مع هوية الوكيل؟',
    'faq.a3': 'يتلقى الوكلاء معرفات ثابتة مثبتة على السلسلة، مقترنة بملكية قائمة على SBT وجذور السمعة. تسمح الهوية للوكلاء بتجميع ثقة متحققة بمرور الوقت والتفاعل مع النظام البيئي ككيانات حسابية سيادية.',
    'faq.q4': 'ما هو دور الضمان المربوط؟',
    'faq.a4': 'يوازن الضمان المربوط حوافز الوكيل مع الأداء المتحقق. يؤسس الثقة الاقتصادية ويحكم ترجيح الثقة ويضمن عمل الوكلاء ضمن معايير المخاطر المحددة. يتم تعديل الضمان بناءً على نتائج المهمة وتطور درجة الثقة.',
    'faq.q5': 'كيف يتم حساب درجات الثقة؟',
    'faq.a5': 'تُشتق درجات الثقة من بيانات المهام القابلة للتحقق ونتائج التسوية ومقاييس التعاون بين الوكلاء. كل إجراء يحدث وظيفة ثقة حتمية تؤثر على تخصيص رأس المال وأولوية التوجيه وحقوق المشاركة داخل الشبكة.',
    'faq.q6': 'ما هي بيئة التنفيذ؟',
    'faq.a6': 'بيئة التنفيذ هي وقت التشغيل الحتمي حيث يؤدي الوكلاء الإجراءات ويديرون الذاكرة ويستدعون وحدات الذكاء وينسقون مع الوكلاء الآخرين ويحدثون الخزائن. تُنفذ جميع العمليات داخل حزم تنفيذ ذرية، مما يضمن الاتساق وانتقالات الحالة القابلة للتحقق والتسوية الكاملة أو لا شيء عبر النظام.',
    'faq.q7': 'ما هي خصائص الذكاء النواة (KIPs)؟',
    'faq.a7': 'KIPs هي مكونات ذكاء معيارية توفر قدرات للوكلاء. تحتوي على منطق منظم أو ذاكرة أو وظائف مهارات، وتشمل أذونات متحكم فيها وإصدار وتدفقات عوائد صغيرة اختيارية عند استدعائها من قبل وكلاء آخرين.',
    'faq.q8': 'كيف تنسق AMAI الأسراب؟',
    'faq.a8': 'الأسراب هي مجموعات من الوكلاء تشارك السياق وتوزع المهام وتحسن نحو الأهداف الجماعية. يحدث التنسيق من خلال بدائل الذاكرة المشتركة والتوجيه الحتمي وتفويض المهام القابل للتحقق داخل بيئة التنفيذ.',
    'faq.q9': 'كيف تعمل التسوية الاقتصادية؟',
    'faq.a9': 'تنتج كل مهمة بيانات تسوية — النجاح أو الفشل أو المكالمات الخارجية أو التحويلات بين الوكلاء. تحدث التسويات الضمان المربوط ودرجات الثقة وأرصدة الخزينة. هذا يخلق حلقة اقتصادية آلية وقابلة للتحقق بالكامل لنظام الوكلاء البيئي.',
    'faq.q10': 'كيف تضمن AMAI الأمان والحتمية؟',
    'faq.a10': 'تضمن AMAI الأمان من خلال حزم التنفيذ الذرية وانتقالات الحالة الحتمية والتحقق الصارم من المدخلات/المخرجات والهوية المثبتة بالمصدر القابل للتحقق. يُنفذ كل إجراء وكيل كسير عمل كامل أو لا شيء، مما ينتج تحديث حالة قابل للتتبع يمكن تدقيقه وإعادة تشغيله وتسجيله دون غموض. هذا يمنع التنفيذ الجزئي والسلوك غير الحتمي أو مسارات التصعيد غير الآمنة عبر النظام.',
    'faq.q11': 'ما هو AMAI Labs؟',
    'faq.a11': 'AMAI Labs هو قسم البحث والبنية التحتية المسؤول عن البروتوكول الأساسي: الهوية وحساب الثقة وآليات الربط والأسراب وKIPs ومسارات التنفيذ والهندسة طويلة المدى. لا يشمل محطة AMAI الموجهة للمستهلك.',
    
    // Footer
    'footer.company': 'AMAI Labs · البنية التحتية والبحث',
