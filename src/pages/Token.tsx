  ...
  return (
    <main className="min-h-screen bg-black text-white">
      ...
      <section id="summary" className="bg-perspective-grid px-5 py-20 md:px-8 md:py-32">
        <div className="mx-auto grid max-w-7xl gap-12 lg:grid-cols-12 lg:gap-20">
          <header className="lg:col-span-4">
            ...
            <h2 className="mt-5 text-4xl font-light md:text-6xl">A share of the volume.</h2>
          </header>
      ...
      <div className="border-y border-white/10 bg-black px-5 py-5 lg:hidden">
        <label htmlFor="token-chapter-nav" className="mb-2 block font-mono text-[9px] uppercase text-white/35">Jump to chapter</label>
        <select
      ...
      <section className="bg-perspective-grid px-5 py-28 text-center md:px-8 md:py-40">
        <div className="mx-auto max-w-4xl">
          <p className="font-mono text-[10px] uppercase text-[#B4F6AD]/60">Every payment, on the record</p>
          <h2 className="mt-6 text-4xl font-light leading-tight md:text-7xl">Hold the token. Get paid in stock.</h2>
          <div className="mt-12 flex flex-col items-center justify-center gap-6 text-sm font-light sm:flex-row sm:gap-10">
            ...
            <a href="/launchpad" className="border-b border-white/20 pb-1 text-white/60 transition-colors hover:text-white focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-[#B4F6AD]">See the launchpad →</a>
          </div>
        </div>
      </section>
