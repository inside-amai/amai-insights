    ...
    <div className={`bg-black min-h-svh md:min-h-screen overflow-x-hidden ${isMobile ? "overscroll-y-contain touch-pan-y" : ""}`} dir={dir}>
      ...
      <Slide slideNumber={7} footerText={t('tp.footer')}>
        <motion.div
          ...
          viewport={{ once: true }}
        >
          <MicroLabel>07 // THE TEAM</MicroLabel>
      ...
      <Slide slideNumber={12} footerText={t('tp.footer')}>
        <p className="text-[11px] tracking-[0.3em] uppercase text-white/40 font-medium text-center mb-8 md:mb-10">
          12 // THE ROUND
        </p>
        <motion.div
          initial={{ opacity: 0 }}
        ...
        >
          <motion.img
            src={amaiLogo}
            alt="AMAI"
            className="mx-auto h-10 md:h-14 w-auto opacity-90 mb-4"
            initial={{ opacity: 0, y: -10 }}
