  ...
  return (
    <main className="min-h-screen overflow-x-clip bg-perspective-grid font-roboto text-white">
      ...
      <div className="bg-black px-5 py-6 lg:hidden">
         <label htmlFor="chapter-nav" className="mb-3 block text-[10px] font-light uppercase tracking-[0.25em] text-white/60">{copy.jump}</label>
        <select
          id="chapter-nav"
      ...
      <section className="relative px-5 py-28 text-center md:px-8 md:py-40">
        ...
        <div className="relative mx-auto max-w-4xl">
           ...
           <h2 className="mt-6 whitespace-pre-line text-4xl font-medium leading-[1.05] tracking-tight md:text-6xl">{copy.closingTitle}</h2>
