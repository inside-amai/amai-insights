...
const OPERATOR_ROWS = [
  {
    ...
    url: "/uploads/operator/01-collect-green-cyan.svg",
  ...
  },
  {
    ...
    url: "/uploads/operator/02-convert-green-cyan.svg",
  ...
  },
  {
    ...
    url: "/uploads/operator/03-pay-green-cyan.svg",
  ...
  },
  {
    ...
    url: "/uploads/operator/04-lend-idle-green-cyan.svg",
  ...
  },
  {
    ...
    url: "/uploads/operator/05-rebalance-green-cyan.svg",
  ...
  },
  {
    ...
    url: "/uploads/operator/06-sit-out-green-cyan.svg",
    ...
    <div className="bg-black" dir={isRtl ? 'rtl' : 'ltr'}>
      ...
      <div className="h-svh md:h-screen flex flex-col">
        ...
        <div className="flex-1 flex items-center justify-center overflow-hidden relative">
          ...
          />
          <div className="pointer-events-none absolute inset-x-0 bottom-0 h-[55%] z-[1] bg-[radial-gradient(ellipse_at_50%_100%,hsl(var(--cyan-accent)/0.22)_0%,transparent_60%)]" />
          <div className="pointer-events-none absolute inset-x-0 top-0 h-[55%] z-[1] bg-[radial-gradient(ellipse_at_50%_0%,hsl(var(--cyan-accent)/0.22)_0%,transparent_60%)]" />
