...
import { Shield, Bot, Database, ChevronRight, TriangleAlert, CheckCircle2, XCircle, Building2, Cpu, Lock, Fingerprint, Wallet, Network } from "lucide-react";
import amaiLogo from "@/assets/amai-logo-tm.png";

const stageCardClass = "rounded-lg border border-border bg-card shadow-[0_18px_60px_-28px_hsl(var(--trust-blue)/0.18)]";
...
const FlowArrow = () => (
  <div className="hidden xl:flex items-center justify-center self-stretch px-2 text-[hsl(var(--trust-blue))]">
    ...
    <main className="min-h-screen bg-[hsl(var(--background))] text-foreground">
      <section className="relative overflow-hidden px-6 py-20 md:px-10 lg:px-14">
        ...
        <div className="relative mx-auto max-w-[1500px]">
          <div className="mb-12 flex flex-col gap-6 border-b border-border pb-8 lg:flex-row lg:items-end lg:justify-between">
          ...
          <div className="grid gap-6 xl:grid-cols-[1fr_auto_1.05fr_auto_1.25fr_auto_1.2fr] xl:items-stretch">
            <article className={`${stageCardClass} p-6 md:p-7`}>
              ...
              <div className="rounded-lg border border-[hsl(var(--trust-blue)/0.18)] bg-[linear-gradient(180deg,hsl(var(--trust-blue-soft)),hsl(var(--background)))] p-5">
                <div className="flex items-center gap-4">
                  <div className="flex h-20 w-20 items-center justify-center rounded-full border border-[hsl(var(--trust-blue)/0.22)] bg-background shadow-sm">
                    <Bot className="h-10 w-10 text-[hsl(var(--trust-blue))]" strokeWidth={1.6} />
                  </div>
                  <div>
                    <div className="text-lg font-medium text-[hsl(var(--trust-blue-ink))]">Autonomous AI Agent</div>
            ...
            <article className={`${stageCardClass} p-6 md:p-7`}>
              ...
              <div className="relative rounded-lg border border-border bg-[hsl(var(--trust-gray-soft))] p-5">
                ...
                <svg className="mt-5 h-24 w-full" viewBox="0 0 360 96" fill="none" aria-hidden="true">
              ...
              <div className="grid gap-4 lg:grid-cols-[0.92fr_1.08fr]">
                <div className="space-y-4">
                  <div className="rounded-lg border border-[hsl(var(--trust-blue)/0.18)] bg-[hsl(var(--trust-blue-soft))] p-4">
                    ...
                    <p className="mt-2 text-sm leading-relaxed text-foreground/75">Telemetry is captured upstream before execution and written to an Immutable Ledger.</p>
                  </div>
                ...
                <div className="rounded-lg border border-[hsl(var(--trust-blue)/0.22)] bg-[linear-gradient(180deg,hsl(var(--background)),hsl(var(--trust-blue-soft)))] p-5">
            ...
            <article className={`${stageCardClass} p-6 md:p-7`}>
              ...
              <div className="rounded-lg border border-[hsl(var(--trust-blue)/0.18)] bg-[linear-gradient(180deg,hsl(var(--background)),hsl(var(--trust-blue-soft)))] p-5">
