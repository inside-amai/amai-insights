    ...
    <div className="bg-black min-h-screen touch-pan-y" dir={isRTL ? "rtl" : "ltr"}>
      ...
      <Slide slideNumber={9} isRTL={isRTL}>
        <motion.div initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} transition={{ duration: 1.2 }} viewport={{ once: true, margin: "0px" }} className="max-w-3xl mx-auto text-center">
          <motion.div className="space-y-4 md:space-y-6 text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-light text-white leading-[1.2] mb-10 md:mb-16" initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 1, delay: 0.3 }} viewport={{ once: true }}>
            <p>Accountability</p>
            <p>Transparency</p>
            <p>Trust</p>
          </motion.div>
          <motion.p className="text-2xl sm:text-3xl md:text-4xl font-light text-white/70" initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 0.8, delay: 0.6 }} viewport={{ once: true }}>
            That is AMAI
          </motion.p>
        </motion.div>
      </Slide>
