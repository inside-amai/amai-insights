        ...
        <div className="relative bg-perspective-grid">
          ...
          <div
            ...
            style={{
              ...
              maskImage: 'linear-gradient(to bottom, rgba(0,0,0,1) 0%, rgba(0,0,0,0.4) 50%, transparent 100%)',
              WebkitMaskImage: 'linear-gradient(to bottom, rgba(0,0,0,1) 0%, rgba(0,0,0,0.4) 50%, transparent 100%)',
            }}
          />
