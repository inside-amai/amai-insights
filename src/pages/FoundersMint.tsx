    ...
    <div className="min-h-screen bg-black text-white overflow-x-hidden founders-mint-page">
      ...
      <div className="fixed top-20 left-6 z-50">
        <Button 
          size="sm"
          variant="outline"
          className="bg-[#D6A6FC]/10 border-[#D6A6FC]/50 text-[#D6A6FC] hover:bg-white hover:text-black hover:border-white px-4 py-2 text-sm font-medium rounded-lg transition-all duration-300 backdrop-blur-sm"
              ...
              <div className="relative">
                <div className="w-80 h-80 bg-gradient-to-br from-amber-400/20 via-amber-600/10 to-transparent rounded-full flex items-center justify-center border border-amber-400/30">
                  <div className="w-60 h-60 bg-gradient-to-br from-amber-500/30 to-amber-700/20 rounded-full flex items-center justify-center border border-amber-400/40">
                    <Trophy className="w-32 h-32 text-amber-400" style={{
                      background: 'linear-gradient(90deg, #FFD700 0%, #FFFFFF 25%, #FFA500 50%, #FFFFFF 75%, #FFD700 100%)',
