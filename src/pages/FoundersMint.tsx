    ...
    <div className="min-h-screen bg-black text-white overflow-x-hidden founders-mint-page">
      ...
      <div className="fixed top-20 left-6 z-50">
        <Button 
          size="sm"
          variant="outline"
          className="bg-[#D6A6FC]/10 border-[#D6A6FC]/50 text-[#D6A6FC] hover:text-white hover:border-[#D6A6FC] px-4 py-2 text-sm font-medium rounded-full transition-all duration-300 backdrop-blur-sm"
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-center max-w-7xl mx-auto">
            ...
            <div className="space-y-8 lg:col-span-6">
              ...
              <div className="space-y-6">
                <div className="text-lg text-gray-300 mb-6">Only 12 governance tokens will ever exist, making you one of the most exclusive members of the AMAI ecosystem.</div>
                <div className="text-lg text-gray-300 mb-6">First-come, first-serve allocation ensures immediate ownership for committed visionaries.</div>
                <div className="text-lg text-gray-300">A place inside the Founders Circle grants you direct influence over AMAI's strategic direction & access to the most valuable opportunities.</div>
              </div>
            </div>
          </div>
        </div>
