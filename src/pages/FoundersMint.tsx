        ...
        <div className="container mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-center max-w-7xl mx-auto">
            ...
            <div className="space-y-8 lg:col-span-6 relative z-20">
              <div className="mb-8">
                <h2 className="text-4xl md:text-5xl font-bold bg-gradient-to-r from-amber-300 via-amber-400 to-amber-600 bg-clip-text text-transparent shimmer-text-gold">
                  What Is Founders Mint?
                </h2>
              </div>
              
              <div className="space-y-6 relative z-20">
                <div className="text-lg text-gray-300 mb-6 relative z-20">Only 12 Special Edition Founders Key tokens will ever exist, making you one of the most exclusive members of the AMAI ecosystem.</div>
