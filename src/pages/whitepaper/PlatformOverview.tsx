    ...
    >
      ...
      <div className="space-y-12">
        ...
        <div className="space-y-10">
          ...
          <h2 className="text-2xl font-bold text-white mb-6 mt-16 tracking-tight">
          ...
          <p className="text-base leading-relaxed text-gray-400 mb-12">
          ...
          <ul className="list-disc pl-6 mb-6 text-base text-gray-400">
          ...
          <ol className="list-decimal pl-6 mb-6 text-base text-gray-400 space-y-2">
          ...
          <ul className="list-disc pl-6 mb-6 text-base text-gray-400 space-y-1">
          ...
          <ul className="list-disc pl-6 mb-8 text-base text-gray-400 space-y-2">
          ...
          <p className="text-base leading-relaxed text-gray-400 mb-16">
          ...
          <div className="bg-gray-900/50 border border-gray-800 rounded-lg p-6 mb-6 text-center">
