    ...
    >
      <div className="space-y-8">
        ...
        <div className="prose prose-lg max-w-none text-white">
          <h2 className="text-2xl font-bold text-white mb-4">Utility-only AMAI token, burn mechanics, circuit-breaker governance, key risks</h2>
          
          <p className="text-gray-300 leading-relaxed">
            TODO: Comprehensive overview of AMAI tokenomics, governance structure, and risk management framework.
          </p>

          <h3 className="text-xl font-semibold text-white mt-8 mb-4">AMAI Token</h3>
          ...
          <h3 className="text-xl font-semibold text-white mt-8 mb-4">Governance Framework</h3>
          ...
          <h3 className="text-xl font-semibold text-white mt-8 mb-4">Risk Management</h3>
