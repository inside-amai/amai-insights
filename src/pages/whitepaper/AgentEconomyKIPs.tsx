...
const AgentEconomyKIPs = () => {
  ...
  useEffect(() => {
    document.title = `${t('kips.title')} | AMAI Labs`;
    window.scrollTo(0, 0);
  }, [t]);
      ...
      <div className="relative z-10">
        ...
        <div className="pt-20 px-6">
          <div className="max-w-4xl mx-auto">
            ...
            >
              {isRTL ? (
                <>{t('kips.back')}<ArrowRight className="ms-2 h-3 w-3" /></>
              ) : (
                <><ArrowLeft className="me-2 h-3 w-3" />{t('kips.back')}</>
              )}
            </Button>
          </div>
        </div>
        ...
        <section className="py-16 px-6">
          <div className="max-w-4xl mx-auto">
            ...
            >
              ...
              <ol className="space-y-2 text-white/50 text-sm list-decimal ms-6">
        ...
        <section className="py-16 px-6">
          <div className="max-w-4xl mx-auto">
            <motion.div
              ...
              transition={{ duration: 0.6 }}
            >
              <h2 className="text-xl font-light text-white mb-6 tracking-tight">{t('kips.why.title')}</h2>
              <p className="text-white/50 text-sm leading-relaxed">
                {t('kips.why.desc')}
              </p>
            </motion.div>
        ...
        <section className="py-16 px-6">
          <div className="max-w-4xl mx-auto">
            <motion.div
              ...
              transition={{ duration: 0.6 }}
            >
              <h2 className="text-xl font-light text-white mb-8 tracking-tight">{t('kips.diagram.title')}</h2>
              ...
              <div className="relative bg-black/40 border border-white/10 rounded-sm p-8 overflow-hidden">
                ...
                <div className="relative z-10 space-y-3">
                  ...
                  <div className="flex justify-center">
                    ...
                    >
                      <div className="text-white/40 text-xs font-mono mb-3 tracking-wider text-center">{t('kips.diagram.metadata')}</div>
                      <div className="grid grid-cols-2 md:grid-cols-4 gap-3 justify-items-center">
                        <div className="text-white/60 text-xs">{t('kips.diagram.contentHash')}</div>
                        <div className="text-white/60 text-xs">{t('kips.diagram.provenance')}</div>
                        <div className="text-white/60 text-xs">{t('kips.diagram.lineage')}</div>
                        <div className="text-white/60 text-xs">{t('kips.diagram.permissions')}</div>
                      </div>
                    </motion.div>
                  </div>
                  ...
                  <div className="flex flex-col lg:flex-row gap-2 items-center justify-center">
                    ...
                    >
                      <div className="text-white/40 text-xs font-mono mb-3 tracking-wider">{t('kips.diagram.parameters')}</div>
                      <div className="space-y-2">
                        <div className="text-white/50 text-xs">{t('kips.diagram.verificationLevel')}</div>
                        <div className="text-white/50 text-xs">{t('kips.diagram.dependencyGraph')}</div>
                        <div className="text-white/50 text-xs">{t('kips.diagram.royaltyParams')}</div>
                        <div className="text-white/50 text-xs">{t('kips.diagram.licensingTerms')}</div>
                      </div>
                    </motion.div>
                    ...
                    <div className="hidden lg:flex items-center">
                      ...
                      <div className={`w-0 h-0 border-t-[4px] border-t-transparent border-b-[4px] border-b-transparent ${isRTL ? 'border-r-[5px] border-r-white/20' : 'border-l-[5px] border-l-white/20'}`} />
                    </div>
                    ...
                    >
                      <div className="text-white/50 text-xs font-mono mb-3 tracking-wider text-center">{t('kips.diagram.module')}</div>
                      <div className="space-y-3">
                        <div className="flex items-center gap-2">
                          <div className="w-1.5 h-1.5 rounded-full bg-white/30" />
                          <span className="text-white/60 text-xs">{t('kips.diagram.inputSchema')}</span>
                        </div>
                        <div className="flex items-center gap-2">
                          <div className="w-1.5 h-1.5 rounded-full bg-white/30" />
                          <span className="text-white/60 text-xs">{t('kips.diagram.processingLogic')}</span>
                        </div>
                        <div className="flex items-center gap-2">
                          <div className="w-1.5 h-1.5 rounded-full bg-white/30" />
                          <span className="text-white/60 text-xs">{t('kips.diagram.outputSchema')}</span>
                        </div>
                        <div className="flex items-center gap-2">
                          <div className="w-1.5 h-1.5 rounded-full bg-white/30" />
                          <span className="text-white/60 text-xs">{t('kips.diagram.resourceConstraints')}</span>
                        </div>
                      </div>
                    </motion.div>
                  </div>
