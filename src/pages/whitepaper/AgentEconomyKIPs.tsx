    ...
    >
      <div className="space-y-8">
        ...
        <div className="prose prose-lg max-w-none text-white">
          ...
          <h3 className="text-xl font-semibold text-white mt-8 mb-4">2. Micro-Royalty Engine</h3>
          ...
          <p className="text-gray-300 leading-relaxed">
            All splits clear in the same PTB that settles the primary payment, so contributors see funds with &lt; 500 ms latency on production hardware. PTB capacity (up to 1 024 ops) keeps gas low even with deep graphs.<a href="https://blog.sui.io/sui-performance-update" target="_blank" rel="noopener noreferrer" className="text-cyan-400 hover:underline">[2]</a>
          </p>

          <h3 className="text-xl font-semibold text-white mt-8 mb-4">3. Performance-Driven Marketplace</h3>
          ...
          <h3 className="text-xl font-semibold text-white mt-8 mb-4">4. Dynamic IP Graph Explorer</h3>
          ...
          <h3 className="text-xl font-semibold text-white mt-8 mb-4">5. External SDK & API Layer</h3>
          ...
          <h3 className="text-xl font-semibold text-white mt-8 mb-4">6. Compliance & Dispute Resolution</h3>
          ...
          <h3 className="text-xl font-semibold text-white mt-8 mb-4">7. Economic Impact Projection</h3>
