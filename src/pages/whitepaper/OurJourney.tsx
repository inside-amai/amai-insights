    ...
    >
      <div className="space-y-8">
        ...
        <div className="prose prose-lg max-w-none text-white">
          ...
          <h3 className="text-xl font-semibold text-white mb-4">Why Sui?</h3>
          <p className="text-gray-300 leading-relaxed mb-6">
          ...
          <h3 className="text-xl font-semibold text-white mb-4">Where We Are Now</h3>
          <p className="text-gray-300 leading-relaxed mb-6">
          ...
          <h3 className="text-xl font-semibold text-white mb-4">Where We Are Going</h3>
          <p className="text-gray-300 leading-relaxed mb-6">
          ...
          <h3 className="text-xl font-semibold text-white mb-4">Why This Matters</h3>
          <p className="text-gray-300 leading-relaxed mb-6">
          ...
          <h3 className="text-xl font-semibold text-white mb-4">How We Build</h3>
          <p className="text-gray-300 leading-relaxed mb-6">
