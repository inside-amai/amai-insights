    ...
    >
      <div className="space-y-12">
        ...
        <div className="text-center">
          ...
          <p className="text-xl lg:text-2xl text-gray-400 mt-2 mb-8">
        ...
        <div className="space-y-8">
          ...
          <div>
            <h2 className="text-xl font-semibold text-white mb-6 tracking-tight">Paradigms Overview</h2>
            
            <div className="overflow-x-auto">
              <table className="w-full border border-gray-800 text-sm">
                <thead>
                  <tr className="border-b border-gray-800 bg-gray-900/50">
                    <th className="text-left py-3 px-4 text-gray-300 font-medium">Paradigm</th>
                    <th className="text-left py-3 px-4 text-gray-300 font-medium">Interaction & Feedback</th>
                    <th className="text-left py-3 px-4 text-gray-300 font-medium">Key Techniques</th>
                  </tr>
                </thead>
                <tbody>
                  <tr className="border-b border-gray-800/50">
                    <td className="py-3 px-4 text-gray-400">Model Offline Pretraining (MOP)</td>
                    <td className="py-3 px-4 text-gray-400">Model ↔ Static data (loss/backprop)</td>
                    <td className="py-3 px-4 text-gray-400">
                      Transformer Pretraining, BPE / SentencePiece, MoE and Pipeline Parallelism
                    </td>
                  </tr>
                  <tr className="border-b border-gray-800/50">
                    <td className="py-3 px-4 text-gray-400">Model Online Adaptation (MOA)</td>
                    <td className="py-3 px-4 text-gray-400">Model ↔ Supervision (labels/scores/rewards)</td>
                    <td className="py-3 px-4 text-gray-400">
                      Task fine-tuning, Instruction tuning, LoRA / Adapters, RLHF
                    </td>
                  </tr>
                  <tr className="border-b border-gray-800/50">
                    <td className="py-3 px-4 text-gray-400">Multi-Agent Orchestration (MAO)</td>
                    <td className="py-3 px-4 text-gray-400">Agent₁ ↔ Agent₂ (message exchange)</td>
                    <td className="py-3 px-4 text-gray-400">
                      Multi-agent systems, Self-reflection, Multi-agent debate, Function calling
                    </td>
                  </tr>
                  <tr>
                    <td className="py-3 px-4 text-gray-400">Multi-Agent Self-Evolving (MASE)</td>
                    <td className="py-3 px-4 text-gray-400">Agents ↔ Environment (signals from env.)</td>
                    <td className="py-3 px-4 text-gray-400">
          ...
          <div>
            <h3 className="text-lg font-semibold text-white mb-4 tracking-tight">Why Sui?</h3>
            <p className="text-gray-400 leading-relaxed text-base">
          ...
          <div>
            <h3 className="text-lg font-semibold text-white mb-4 tracking-tight">Where We Are Now</h3>
            <p className="text-gray-400 leading-relaxed text-base">
          ...
          <div>
            <h3 className="text-lg font-semibold text-white mb-4 tracking-tight">Where We Are Going</h3>
            <p className="text-gray-400 leading-relaxed text-base">
          ...
          <div>
            <h3 className="text-lg font-semibold text-white mb-4 tracking-tight">Why This Matters</h3>
            <p className="text-gray-400 leading-relaxed text-base">
          ...
          <div>
            <h3 className="text-lg font-semibold text-white mb-4 tracking-tight">How We Build</h3>
            <p className="text-gray-400 leading-relaxed text-base">
