  ...
  return (
    <div className="min-h-screen bg-black relative overflow-hidden">
      ...
      <div className="fixed top-6 right-6 z-50">
        <span className="text-white/30 font-mono text-xs tracking-wider">04 / 09</span>
      </div>
          ...
          <div className="max-w-4xl mx-auto">
            ...
            >
              ...
              <div className="relative bg-black/40 border border-white/10 rounded-sm p-8 overflow-hidden">
                ...
                <div className="relative z-10 flex flex-col lg:flex-row gap-6 lg:gap-4 justify-center items-stretch">
