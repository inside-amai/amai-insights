          ...
          {faqs.map((faq, index) => {
            ...
            return (
              ...
              >
                ...
                >
                  <div className="grid grid-cols-[auto_1fr_auto] gap-4 md:gap-6 items-start py-6 md:py-7 px-2 md:px-4">
                    <span className="pt-1 text-sm md:text-base font-mono text-cyan-accent/70 tabular-nums">
                      {faq.num}
                    </span>
                    <span className="text-[19px] md:text-[22px] font-normal text-white/90 leading-tight">
                      {faq.question}
                    </span>
                  ...
                  {isOpen && (
                    ...
                    >
                      <div className="pb-7 md:pb-8 px-2 md:px-4">
                        <div className="pl-0 md:pl-[calc(1.5rem+2rem)] max-w-[65ch]">
