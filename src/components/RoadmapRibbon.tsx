      ...
      <div className="container mx-auto px-4">
        ...
        <div className="flex flex-col md:flex-row justify-center md:gap-20 gap-12 max-w-7xl mx-auto px-6">
          ...
          {stages.map((stage, index) => (
            <div
              key={index}
              className="ribbon-card relative flex flex-col justify-center gap-3 p-8 md:p-10 rounded-2xl border border-white/10 bg-white/5 backdrop-blur min-h-[280px] md:min-h-[260px] w-full max-w-none flex-1 shadow-[0_0_18px_-4px_rgba(166,252,252,0.35)] md:shadow-[0_0_28px_-6px_rgba(166,252,252,0.45)] transition-all duration-700 opacity-0 translate-y-6 mx-auto md:mx-0"
            >
              <span className="absolute -top-3 left-1/2 -translate-x-1/2 min-w-[7.5rem] px-4 py-2 text-sm font-bold rounded-full bg-gradient-to-r from-[#A6FCFC] to-[#D6A6FC] text-black text-center">
                {stage.pill}
              </span>
              <h3 className="text-xl md:text-2xl font-semibold mb-3 mt-6 md:mt-3">
                {stage.title}
              </h3>
