      ...
      <div className="container mx-auto px-4">
        ...
        <div className="flex flex-col md:flex-row justify-center md:gap-20 gap-12 max-w-7xl mx-auto px-6">
          ...
          {stages.map((stage, index) => (
            ...
            >
              <span className="absolute -top-3 left-1/2 -translate-x-1/2 min-w-[6.5rem] px-3 py-1 text-xs font-medium rounded-full bg-gradient-to-r from-[#A6FCFC] to-[#D6A6FC] text-black text-center">
                {stage.pill}
              </span>
