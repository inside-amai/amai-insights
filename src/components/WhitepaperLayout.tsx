    ...
    <div className="min-h-screen bg-black relative overflow-hidden">
      ...
      <div className="fixed top-6 left-6 z-50 relative">
        <Button 
          variant="outline" 
          size="sm" 
          className="bg-cyan-500/20 backdrop-blur-sm border-cyan-400/30 text-white hover:bg-cyan-500/25"
          onClick={() => {
            navigate('/');
            setTimeout(() => {
          ...
          <div className="max-w-4xl mx-auto flex justify-between items-center">
            {prevSection ? (
              <Button 
                asChild 
                variant="outline" 
                className="group bg-cyan-500/20 backdrop-blur-sm border-cyan-400/30 text-white hover:bg-cyan-500/25"
