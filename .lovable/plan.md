...
3. Remove repeated scroll-triggered transforms and blur from the TARI panel on mobile; preserve its final visible state and keep desktop animation unchanged.
